...
const BlogPage = () => {
  ...
  }, [searchQuery, activeCategory]); // Re-observe when filter results update
  ...
  return (
    <div className="blog-page-wrapper">
      ...
      <section className="blog-hero">
        <div className="blog-hero-container reveal-on-scroll fade-in-up">
      ...
      <section className="blog-categories">
        <div className="categories-container reveal-on-scroll fade-in-up">
      ...
      <section className="blog-content">
        <div className="blog-container">
          ...
          {isFeaturedVisible && !searchQuery && (
            <div className="featured-post-card reveal-on-scroll scale-in">
          ...
          {filteredPosts.length > 0 ? (
            <div className="articles-grid">
              {filteredPosts.map((post, index) => (
                <article
                  key={post.id}
                  className="post-card reveal-on-scroll fade-in-up"
            ...
            <div className="no-results reveal-on-scroll fade-in-up">
      ...
      <section className="blog-newsletter">
        <div className="newsletter-container reveal-on-scroll fade-in-up">
